...
class CustomTypeReflectionTest(fixtures.TestBase):
    class NTL:
        def __init__(self, enums, domains, collations=None):
            self.enums = enums
    ...
    def _assert_reflected(self, dialect):
        for sch, args in [
            ...
            row_dict = {
                ...
                "not_null": False,
                "type": 123,
                "collation": 456 if sch == "my_custom_type()" else 0,
                "comment": None,
                "generated": "",
            ...
            if sch == "my_custom_type()":
                ...
                eq_(column_info["type"].collation_schema, "collnsp")
            else:
    ...
    def test_no_format_type(self):
        ...
        with expect_warnings(
            ...
            column_info = dialect._get_columns_info(
                [row_dict],
                self.NTL({}, {}, {654: ("somecollation", None, [])}),
                "public",
            )
            assert ("public", "tblname") in column_info
            column_info = column_info[("public", "tblname")]
