# Issue review unit: re-entrant handle_error call if an exception is raised in result.all() within a DML process
...
`COMMIT-0c2c8eacc041dd069c86806e781a8d198a590b9b`; no upstream mention is required.
