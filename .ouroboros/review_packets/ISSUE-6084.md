# Issue review unit â€” version_id_col should accept string attr name like polymorphic_on does, make sure all mapper args that point to a column can work like this
...
- Issue #6084: `revalidated_acceptance_probe`
