# Issue review unit â€” Declaring Composite Column Types as Optional leads to NULL data type for constituent columns in table definition

- **Covered issues:** #10380
- **Review unit:** `none`
...
- Issue #10380: `revalidated_acceptance_probe`
