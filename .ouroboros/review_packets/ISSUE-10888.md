# Issue review unit: OrderingList typing incorrect / incomplete and implementation doesn't accept non-int indices
...
`COMMIT-eee3fb2285fda2db38ff88b337d2a53c71f124bd`; no upstream mention is required.
