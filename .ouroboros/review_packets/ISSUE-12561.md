# Issue review unit â€” Recover two-phase in mysql is currently unusable since it uses a legacy row index method

- **Covered issues:** #12561
- **Review unit:** `none`
...
- Issue #12561: `revalidated_acceptance_probe`
