# Issue review unit â€” Applying a loader option to a parent relationship when using with_polymorphic does not work properly

- **Covered issues:** #13210
- **Review unit:** `none`
...
- Issue #13210: `revalidated_acceptance_probe`
