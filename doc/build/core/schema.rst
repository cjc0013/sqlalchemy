...
:class:`~sqlalchemy.Table`, :class:`~sqlalchemy.Column`,
:class:`~sqlalchemy.ForeignKey` and
:class:`~sqlalchemy.Sequence`, all of which are imported from the
...
as :class:`~sqlalchemy.Table`, assign it a name, and then instruct
